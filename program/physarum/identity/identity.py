...
class Identity(ProgramBase):
    ...
    def initProgram(self, reload=False):
        ...
        frag_path = join(dirname(__file__), "identity.glsl")
...
@register_node(OP_CODE_IDENTITY)
class IdentityNode(ShaderNode, Physarum):
    op_title = "Identity"
    op_code = OP_CODE_IDENTITY
    content_label = ""
    content_label_objname = "shader_identity"
