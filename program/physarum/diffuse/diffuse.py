...
class Diffuse(ProgramBase):
    ...
    def initProgram(self, reload=False):
        ...
        frag_path = join(dirname(__file__), "diffuse.glsl")
...
@register_node(OP_CODE_DIFFUSE)
class DiffuseNode(ShaderNode, Physarum):
    op_title = "Diffuse"
    op_code = OP_CODE_DIFFUSE
    content_label = ""
    content_label_objname = "shader_diffuse"
