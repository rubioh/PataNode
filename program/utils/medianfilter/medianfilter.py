...
class Median(ProgramBase):
    ...
    def initProgram(self, reload=False):
        ...
        frag_path = join(dirname(__file__), "medianfilter.glsl")
...
@register_node(OP_CODE_MEDIAN)
class MedianNode(ShaderNode, Utils):
    op_title = "Median Filter"
    op_code = OP_CODE_MEDIAN
    content_label = ""
    content_label_objname = "shader_median"
