...
#		self.textures["emissiveTexture"] = None
		self.uniforms["in_albedo"] = glm.vec4(1., 1., 1, 0.)
		self.uniforms["in_metallic"] = 0.0
		self.uniforms["in_roughness"] = 0.5
		self.uniforms["in_emissive"] = glm.vec4(0., 0., 0., 0.)
	...
	def init_from_gltf(self, gltf, pygltf_material, scene):
		...
		if mat.baseColorTexture:
			self.textures["baseColorTexture"] = scene.get_texture_resource_index_from_gltf_source(gltf, mat.baseColorTexture.index)
