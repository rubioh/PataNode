...
class BumpMapping(ProgramBase):
    ...
    def initProgram(self, reload=False):
        ...
        frag_path = join(dirname(__file__), "bumpmapping.glsl")
...
@register_node(OP_CODE_BUMPMAPPING)
class BumpMappingNode(ShaderNode, Effects):
    op_title = "BumpMapping"
    op_code = OP_CODE_BUMPMAPPING
    content_label = ""
    content_label_objname = "shader_bumpmapping"
