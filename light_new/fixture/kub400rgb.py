...
class Kub400RGB(Fixture):
    ...
    CHANNELS_DEFAULTS = {"mode":90/255., "pattern_selection": 0, "pattern_rotation": 0, "pattern_horizontal_rotation": 0,
                        "pattern_vertical_rotation": 0, "pattern_horizontal_movement":0, "pattern_vertical_movement": 0,
                        "zoom_pattern": 65/255., "color_selection": 0}
